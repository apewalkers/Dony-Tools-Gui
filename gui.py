...
# Get the path of the /bin/ subfolder
bin_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "bin")
sys.path.append(bin_dir)  # Append the /bin/ directory to sys.path

# Import 'decoded' from the /bin/ subfolder
import decoded

import msvcrt  # For getch() in Windows, or use an alternative for other OS
